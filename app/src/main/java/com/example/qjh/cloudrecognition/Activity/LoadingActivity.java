...
import com.example.qjh.cloudrecognition.utils.Bing_Paper;
import com.example.qjh.cloudrecognition.logins.HttpUtill;
...
public class LoadingActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.common_activity_beginning);
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Glide.with(LoadingActivity.this).load("http://cn.bing.com" +
