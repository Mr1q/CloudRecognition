...
import com.example.qjh.cloudrecognition.Control.SearchPOI;
import com.example.qjh.cloudrecognition.R;
import com.example.qjh.cloudrecognition.user_msg.Me_Cot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User_Img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, Me_Cot.class);
      ...
      //  LatLng s = new LatLng(110.316843, 25.366123);//构造一个位置
       // map.moveCamera(CameraUpdateFactory.changeLatLng(s));
        // map.setPointToCenter(110,25);  固定中心点
...
//            LatLng latLngs = new LatLng(lon, lat);
//            Log.d("TAG", "onCreate: " + lon + "--" + lat);
//            map.moveCamera(CameraUpdateFactory.changeLatLng(latLngs));
//        }
    ...
    private void removeMarksFromMap() {
        List<Marker> saveMarkerList = map.getMapScreenMarkers();//获得所有地图上所有Maker.
    ...
    private void Initial() {
        ...
        searchView = (LinearLayout) findViewById(R.id.search_enter);
    ...
    private void showContacts() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
            ...
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.
                    ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.
                    READ_PHONE_STATE}, BAIDU_READ_PHONE_STATE);
        } else {
            Begin_Loc();
        }
    }
